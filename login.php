    ...
    <nav x-data="{ menuOpen: false }" class="w-full bg-white shadow-md py-4 px-6 border-b relative">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-3 mr-[10%]">
                ...
                <?php else: ?>
                    <a href="login.php" class="text-xl font-semibold text-white bg-blue-500 hover:bg-blue-700 rounded-md px-3 py-2 transition">Login</a>
            ...
            <div x-show="menuOpen" x-cloak 
                ...
                <div class="mt-12 flex flex-col space-y-4 text-xl">
                    ...
                    <?php else: ?>
                        <a href="login.php" class="text-blue-500 text-white bg-blue-500 hover:bg-blue-700 rounded-md px-4 py-2 transition" @click="menuOpen = false">Login</a>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md border mb-[25%] lg:mb-[0%] w-[320px] md:w-[350px] lg:w-[400px]">
            ...
            <form method="POST" action="" class="space-y-4">
                ...
                <div class="flex items-center">
                    ...
                    <input type="password" id="password" name="password" placeholder="Enter Password" class="w-2/3 p-2 border rounded hover:border-gray-400" required>
                </div>
